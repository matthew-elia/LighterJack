	...
	$scope.blueConnect = function () {
	    ...
	    setInterval(function () { 
			    ...
			    console.log('Connected');
		 			...
		 			console.log(''+error+'');
		 			$cordovaVibration.vibrate(1800);
				});
		  },2500);  
	  });
	}
	$scope.blueDisconnect = function () {
		$cordovaBLE.disconnect('C7A3D191-E205-912E-C984-0E454CFC8D07').then(function () {
		});
  }

})

.controller('AccountController', function ($scope, $cordovaVibration) {
	$scope.cancelVibrate = function () {
